...
After policy/approval and pre-execution revalidation:
...
```json
{
  ...
  "display_summary": {
    ...
    "summary": "500 units, agreed commercial terms attached"
  },
...
Those states belong to external transaction/order integrations.
