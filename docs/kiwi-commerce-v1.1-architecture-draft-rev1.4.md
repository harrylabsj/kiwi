...
supersedes_draft: "doc_revision 1.3"
...
```text
docs/products/kiwi-catalog-product-architecture-v0.2.md
docs/products/shopping-cli-commerce-data-hub-v0.2.md
```
...
```text
docs/protocol/kiwi-transaction-handoff-0.1-rev0.2.md
```
...
27. `[N]` Handoff `DELIVERED` / `OPENED` 不得被记录或展示成外部订单、支付、履约成功；只有外部 authoritative system 的明确事件才可形成对应交易事实。
...
docs/
  CURRENT-DOCS.md
  kiwi-commerce-v1.1-architecture-draft-rev1.4.md

docs/products/
  kiwi-catalog-product-architecture-v0.2.md
  shopping-cli-commerce-data-hub-v0.2.md

docs/protocol/
  kiwi-negotiation-protocol-1.0-rev1.4.md
  kiwi-transaction-handoff-0.1-rev0.2.md

docs/testing/
  kiwi-commerce-v1.1-test-plan.md
```
