...
does not carry released v1.0 canonical files or the readiness audit; after merging,
those continue to be read from `docs/` and `docs/reviews/` as they exist in the repo.
